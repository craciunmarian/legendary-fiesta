...
<head>
    ...
    <link rel="stylesheet" href="/public/css/about/about_page.css">
...
<body id="body">
    ...
    <div class="gallery">
        <div class="portrait">
            <img class="portrait__picture" src="/public/assets/about/adana_pfp.png" alt="pic 1">
            <p class="name">Adana Popescu</p>
            <div class="dash"></div>
            <p class="email">adana.popescu22@gmail.com</p>
        </div>
        <div class="portrait">
            <img class="portrait__picture" src="/public/assets/about/adrian_pfp.jpg" alt="pic 2">
            <p class="name">Vătui Adrian</p>
            <div class="dash"></div>
            <p class="email">adrianvatui9989@yahoo.com</p>
        </div>
        <div class="portrait">
            <img class="portrait__picture" src="/public/assets/about/razvan_pfp.jpg" alt="pic 3">
    ...
    <footer>
        <a href="/public/about/report" class="footer__text">Documentatie</a>
