...
//   var imgData = chartElem.toDataURL("image/jpeg", 1.0);
...
function createSvgLink(filename, linkText, chart, chartSettings) {
  ...
  document.getElementById('btns').appendChild(link);
}
